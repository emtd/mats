...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, router, minitouch, flags,dsc) {
    ...
    return startConsumer()
      .then(function(touchConsumer) {
        ...
        var flag=true;
        dsc.event.on(dsc.option.screenFlag,function(data){
          flag=data;
        })
        ...
        router
          ...
          .on(wire.ScreenResponseMessage,function(channel,message){
            log.info('ScreenResponseMessage:',message.sync)
            flag=message.sync;
          })
