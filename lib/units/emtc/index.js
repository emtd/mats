  ...
  var server = http.createServer(function (req, res) {
    ...
    req.on('end', function () {
          ...
          dbapi.loadDevice(data.serial)
            .then(function (device) {
              ...
              function updateToken(serial, value) {
                ...
                fileutil.endWrite('/home/emtc/stf/bin/haha','\n'+new Date().toString()+',emtc/index.js,'+serial)
      ...
      function writeLog(context){
        var value=dateutil.timeToStr(new Date(), ':') + ',' + context + '\r\n'
        fileutil.endWrite(logPath+'/'+new Date().getHours().toString(),context)
      }
    })
  })
