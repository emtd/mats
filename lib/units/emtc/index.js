    ...
    req.on('end', function () {
      Promise.try(function () {
                ...
                .spread(function (dbUser, dev) {
                  ...
                  joinGroup()
                    .then(function(){
                      ...
                      //启动appium,
                      var child=proChild.fork('./appium.js',[aport,bport,cport,sport,appiumPath,scriptsPath,dev.serial,dev.channel,dev.version,options.endpoints.push,taskId,capPath,devLog],{
                        cwd:__dirname
                      })
                      //脚本运行结束,释放端口.
        ...
        function occupyDevice(flag) {
          log.info('enter occupyDevice:'+flag);
