...
module.exports = function() {
  ...
  process.env.STF_LOCAL_DEVICE_SERVICE=false;
  process.env.STF_LOCAL_BIND_DEV_PUB='tcp://10.12.32.201:7114';
  process.env.STF_LOCAL_BIND_DEV_PULL='tcp://10.12.32.201:7116';
  process.env.STF_LOCAL_PROXY_MIN_PORT=10000;
  process.env.STF_LOCAL_PROXY_MAX_PORT=10500;

  process.env.IPMAP=Object.create(null);
  process.env.IPMAP['10.12.32.201']='58.215.221.218';
}();
